      ...
      <main className="flex-1 overflow-auto">
        <div className="p-4 lg:p-8">
          ...
          <div className="mb-6 lg:mb-8">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Analysis History</h1>
            <p className="text-sm sm:text-base text-gray-600">View and manage all contract analyses</p>
            <p className="text-xs sm:text-sm text-gray-500 mt-1">3 of 3 analyses shown</p>
          </div>
                ...
                <CardContent className="p-4 lg:p-6">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-start space-x-3 lg:space-x-4 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                          <h3 className="text-base lg:text-lg font-medium text-gray-900 break-words">
                            {analysis.fileName}
                          </h3>
                        ...
                        <div className="flex flex-col gap-1 lg:gap-2 text-xs lg:text-sm text-gray-600 mb-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 border-t pt-4">
                      <button className="px-3 py-2 text-xs lg:text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-md transition-colors">
                        View Details
                      </button>
                      <button className="px-3 py-2 text-xs lg:text-sm font-medium text-gray-600 hover:text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                        Download Report
                      </button>
                    </div>
                  </div>
